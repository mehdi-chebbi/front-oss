...
const en: Translations = {
  ...
  'offer.closes': 'Closes:',
  'offer.countdown.title': 'Application Deadline',
  'offer.countdown.timeLeft': 'Time remaining:',
  'offer.countdown.expired': 'Application period has ended',
  'offer.countdown.expiresIn': 'Expires in',
  'offer.countdown.days': 'days',
  'offer.countdown.hours': 'hours',
  'offer.countdown.minutes': 'minutes',
  'offer.countdown.seconds': 'seconds',
  ...
  'form.otherDocuments.title': 'Other Documents',
  'form.otherDocuments.description': 'Upload any additional documents that may support your application (optional)',
  'form.otherDocuments.addButton': 'Add Document',
  'form.otherDocuments.namePlaceholder': 'Document name',
  'form.otherDocuments.help': 'Add any supporting documents you think may help your application',
  ...
  // Custom required documents translations
  'rh.form.customDocuments.title': 'Required Documents',
  'rh.form.customDocuments.defaultDocuments': 'Default Required Documents (by offer type)',
  'rh.form.customDocuments.additionalDocuments': 'Additional Required Documents',
  'rh.form.customDocuments.noAdditional': 'No additional documents required',
  'rh.form.customDocuments.addNew': 'Add New Required Document',
  'rh.form.customDocuments.placeholder': 'Enter document name...',
  'rh.form.customDocuments.addButton': 'Add Document',
  'rh.form.customDocuments.help': 'Add custom documents that applicants must upload for this offer',
  'rh.form.customDocuments.required': 'Required',
  'rh.form.customDocuments.optional': 'Optional',
  'rh.form.customDocuments.makeRequired': 'Make Required',
  'rh.form.customDocuments.makeOptional': 'Make Optional',
...
const fr: Translations = {
  ...
  'offer.countdown.title': 'Date limite de candidature',
  'offer.countdown.timeLeft': 'Temps restant :',
  'offer.countdown.expired': 'La période de candidature est terminée',
  'offer.countdown.expiresIn': 'Expire dans',
  'offer.countdown.days': 'jours',
  'offer.countdown.hours': 'heures',
  'offer.countdown.minutes': 'minutes',
  'offer.countdown.seconds': 'secondes',
  ...
  // Application form other documents translations
  'form.otherDocuments.title': 'Autres Documents',
  'form.otherDocuments.description': 'Téléchargez tous les documents supplémentaires qui pourraient soutenir votre candidature (optionnel)',
  ...
  // Custom required documents translations
  'rh.form.customDocuments.title': 'Documents Requis',
  'rh.form.customDocuments.defaultDocuments': 'Documents Requis par Défaut (selon le type d\'offre)',
  'rh.form.customDocuments.additionalDocuments': 'Documents Requis Supplémentaires',
  'rh.form.customDocuments.noAdditional': 'Aucun document supplémentaire requis',
  'rh.form.customDocuments.addNew': 'Ajouter un Nouveau Document Requis',
  'rh.form.customDocuments.placeholder': 'Entrez le nom du document...',
  'rh.form.customDocuments.addButton': 'Ajouter le Document',
  'rh.form.customDocuments.help': 'Ajoutez des documents personnalisés que les candidats doivent télécharger pour cette offre',
  'rh.form.customDocuments.required': 'Obligatoire',
  'rh.form.customDocuments.optional': 'Optionnel',
  'rh.form.customDocuments.makeRequired': 'Rendre Obligatoire',
  'rh.form.customDocuments.makeOptional': 'Rendre Optionnel',
